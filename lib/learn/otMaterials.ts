...
// 빈 값(대수/미적분1·2)은 원본도 TODO 상태라서 매핑에서 제외했다.
// URL 은 반드시 Canva 의 "퍼가기(embed)" 형태 — .../view?embed — 여야 iframe 에서 열린다.
...
export const OT_MATERIALS: Record<string, string> = {
  ...
  경제수학:
    "https://www.canva.com/design/DAHSjYE_Frk/bMcKnJC1EJ5nndvsquavjg/view?embed",
};
