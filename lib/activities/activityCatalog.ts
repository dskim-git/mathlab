...
export const ACTIVITY_CATALOG: ActivityGroup[] = [
  ...
  },
  {
    subject: "경제수학",
    unit: "1-2-1 이자와 원리합계",
    slugs: ["economics/mini/interest_rate_lab", "economics/mini/simple_interest_lab", "economics/mini/compound_interest_lab", "economics/mini/rule_of_72_lab", "economics/mini/continuous_compound_lab"],
  },
  {
    subject: "확률과통계",
    unit: "1-1 순열과 조합",
