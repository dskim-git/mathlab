...
export const ACTIVITY_CATALOG: ActivityGroup[] = [
  ...
  },
  {
    subject: "경제수학",
    unit: "1-3 세금",
    slugs: ["economics/mini/tax_lab", "economics/mini/tax_rates_lab", "economics/mini/income_tax_lab", "economics/mini/corporate_tax_lab", "economics/mini/excise_tax_lab"],
  },
  {
    subject: "확률과통계",
    unit: "1-1 순열과 조합",
