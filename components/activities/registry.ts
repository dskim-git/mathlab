...
import CircleLineRelationLab from "./common2/1-2-2-circle-line-relation/circle-line-relation-lab/CircleLineRelationLab";
import CircleTangentLineLab from "./common2/1-2-2-circle-line-relation/circle-tangent-line-lab/CircleTangentLineLab";
...
import CipherInverseLab from "./common2/3-1-3-inverse/cipher-inverse-lab/CipherInverseLab";
...
// 1-1-1 생활 속 경제지표
import StockIndexLab from "./economics/1-1-1-economic-indicators/stock-index-lab/StockIndexLab";
import GdpGrowthLab from "./economics/1-1-1-economic-indicators/gdp-growth-lab/GdpGrowthLab";
import PercentagePointLab from "./economics/1-1-1-economic-indicators/percentage-point-lab/PercentagePointLab";
import EmploymentLab from "./economics/1-1-1-economic-indicators/employment-lab/EmploymentLab";
// 1-1-2 환율
import ExchangeRateLab from "./economics/1-1-2-exchange-rate/exchange-rate-lab/ExchangeRateLab";
import ExchangeImpactLab from "./economics/1-1-2-exchange-rate/exchange-impact-lab/ExchangeImpactLab";
import BigMacLab from "./economics/1-1-2-exchange-rate/bigmac-index-lab/BigMacLab";
import ExchangeSmartLab from "./economics/1-1-2-exchange-rate/exchange-smart-lab/ExchangeSmartLab";
// 1-1-3 세금
import TaxLab from "./economics/1-1-3-tax/tax-lab/TaxLab";
import TaxRatesLab from "./economics/1-1-3-tax/tax-rates-lab/TaxRatesLab";
import IncomeTaxLab from "./economics/1-1-3-tax/income-tax-lab/IncomeTaxLab";
import CorporateTaxLab from "./economics/1-1-3-tax/corporate-tax-lab/CorporateTaxLab";
import VatLab from "./economics/1-1-3-tax/vat-lab/VatLab";
import ExciseTaxLab from "./economics/1-1-3-tax/excise-tax-lab/ExciseTaxLab";
...
export const ACTIVITY_REGISTRY: Record<string, ComponentType> = {
  ...
  "common2/mini/circle_line_relation_lab": CircleLineRelationLab,
  "common2/mini/circle_tangent_line_lab": CircleTangentLineLab,
  ...
  "common2/mini/cipher_inverse_lab": CipherInverseLab,
  ...
  "economics/mini/tax_rates_lab": TaxRatesLab,
  "economics/mini/income_tax_lab": IncomeTaxLab,
