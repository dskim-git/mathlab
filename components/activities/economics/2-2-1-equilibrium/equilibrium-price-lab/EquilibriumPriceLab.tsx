...
function ShiftTab() {
  return (
    <div className="space-y-5">
      ...
      <p className="rounded-xl border border-sky-400/25 bg-sky-400/[0.06] px-3 py-2 text-[11px] leading-5 text-sky-100">
        🧭 <b>가로축이 가격이라는 점에 주의!</b> 경제 책에서 흔히 보는 그림은 가로축이 수량이라 곡선이 좌우로
        움직이지만, 이 활동은 수업 시간과 같이 가로축이 가격이라 <b>증가는 곡선이 위로, 감소는 아래로</b> 움직이는
        것으로 나타나요. 수요곡선(우하향)은 위로 갈 때 오른쪽으로 기울어 보이고, 공급곡선(우상향)은 위로 갈 때
        왼쪽으로 기울어 보이지만 <b>둘 다 «같은 값에서 양이 늘었다»는 뜻</b>이에요.
      </p>
            ...
            <>
              ...
              {ok1 ? (
                <QRow
                  ...
                  options={
                    e.kind === "shift"
                      ? ["⬆️ 위로 — 같은 값에서 양이 늘어요 (증가)", "⬇️ 아래로 — 같은 값에서 양이 줄어요 (감소)"]
                      : ["⬆️ 늘어난다", "⬇️ 줄어든다"]
                  }
                  answer={a2}
                  pick={q2}
